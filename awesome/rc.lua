...
local myawesomemenu = {
    ...
    { "edit config", terminal.." nano /home/andreas/.config/awesome/rc.lua" },
    { "arandr", "arandr" },
...
globalkeys = my_table.join(
    ...
    awful.key({modkey, "Shift" },'s', function() awful.util.spawn ("sylpheed") end,
    	{description = 'open sylpheed email', group = 'launcher'}),
    	
    awful.key({modkey, "Shift" },'e', function() awful.util.spawn ("geary") end,
    	{description = 'open geary email', group = 'launcher'}),
    ...
    awful.key({modkey, "Shift" },'t', function() awful.util.spawn ("st") end,
   ...
   -- awful.key({ modkey,           }, "Escape", awful.tag.history.restore,
    ...
    --awful.key({ altkey, "Shift"   }, "Tab",  awful.tag.viewprev,
     ...
     -- Tag browsing modkey1 + tab
    --awful.key({ modkey1,           }, "Tab",   awful.tag.viewnext,
        --{description = "view next", group = "tag"}),
    --awful.key({ modkey1, "Shift"   }, "Tab",  awful.tag.viewprev,
        --{description = "view previous", group = "tag"}),
  ...
  --  awful.key({ modkey, "Shift" }, "Left", function () lain.util.move_tag(-1) end,
   ...
   -- awful.key({ modkey, "Shift" }, "d", function () lain.util.delete_tag() end,
    ...
    awful.key({ modkey,           }, "Return", function () awful.spawn( terminal ) end,
              {description = "open a terminal", group = "super"}),
    --awful.key({ modkey,           }, "b", function () awful.spawn( browser ) end,
          --  {description = "open a browser", group = "super"}),
    awful.key({ modkey, "Control" }, "r", awesome.restart,
              {description = "reload awesome", group = "awesome"}),
    awful.key({ modkey, "Control"   }, "q", awesome.quit, -- function () awful.spawn.with_shell( '~/.dmenu/prompt "are you sure?" "killall awesome"' ) end,
...
--Autostart Apps
awful.spawn.with_shell("xrandr --output HDMI-1 --off --output DP-1 --mode 1920x1080 --pos 1920x0 --rotate normal --output HDMI-2 --primary --mode 1920x1080 --pos 0x0 --rotate normal")
...
--awful.spawn.with_shell("sleep 1s && blueman-manager &")
awful.spawn.with_shell("lxpolkit &")
--awful.spawn.with_shell("wicd-gtk &")
